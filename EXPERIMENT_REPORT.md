...
## 1. 当前进度（2026-06-19，更新 Table 2 Informer 与 Table 6 重跑）
...
| **Table 2 Informer none 阶段**（Informer × 3 datasets × 4 pred_len × 3 seeds，revin/dishts 补充）| 🔄 **运行中** | **约 85 / 108** | Informer ECL 训练极度不稳定（见 §6.5） |
| **Table 3**（RevIN vs Dishts 扩展）| ⏳ 待开始 | — | — |
